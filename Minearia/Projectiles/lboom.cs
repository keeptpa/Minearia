...
{
    public class lboom : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            if (projectile.ai[1] == 0)
            {
                for (int i = 0; i < 1; i++)
                {
                    ...
                    Projectile.NewProjectile(projectile.Center, vel, mod.ProjectileType("llboom"), projectile.damage, projectile.knockBack, projectile.owner, 0, 1);
                }
