...
namespace Minearia.Projectiles
{
    public class bang : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("BoomerBoom");
        }
        ...
        public override void Kill(int timeLeft)
        {
                ...
                for (int i = 0; i < 5; i++)
                {
                    ...
                    Vector2 vel = new Vector2(Main.rand.NextFloat(-5, 5), Main.rand.NextFloat(-3, 3));
                    Projectile.NewProjectile(projectile.Center, vel, 30, 60, projectile.knockBack, projectile.owner, 0, 1);
                }
